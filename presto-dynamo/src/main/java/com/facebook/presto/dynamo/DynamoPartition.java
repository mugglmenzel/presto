...
public class DynamoPartition
        implements ConnectorPartition
{
    static final String UNPARTITIONED_ID = "<UNPARTITIONED>";
    public static final DynamoPartition UNPARTITIONED = new DynamoPartition();
    ...
    public DynamoPartition(byte[] key, String partitionId, TupleDomain<ConnectorColumnHandle> tupleDomain, boolean indexedColumnPredicatePushdown)
    {
        this.key = key;
