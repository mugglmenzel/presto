        ...
        implements RecordSink
{
    ...
    @Inject
    public DynamoRecordSink(DynamoOutputTableHandle handle, DynamoSession dynamoSession)
    {
    ...
    public void finishRecord()
    {
        ...
        // dynamoSession.execute(schemaName, insertQuery, values.toArray());
    }
